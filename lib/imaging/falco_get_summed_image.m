...
fgsmic = 1
load(['falco_get_summed_image_count_' num2str(fgsmic) '.mat'])
mp.NdmNoiseItr = 10
mp.dm1.noise_mat = 1*randn([size(mp.dm1.V) mp.NdmNoiseItr])
...
% 
% fgsmic = falco_get_summed_image_count;
% 
% disp(['falco_get_summed_image_count ' num2str(fgsmic) ''])
% 
%save(['falco_get_summed_image_count_' num2str(fgsmic) '.mat'])
% 
% falco_get_summed_image_count = falco_get_summed_image_count + 1;


%load('falco_get_summed_image_count_2.mat')
